...
# Order endpoints
def _build_order_response(order, *, include_client_secret: bool = False) -> OrderResponse:
    ...
    return OrderResponse(
        ...
        payment=PaymentIntentResponse(
            ...
            client_secret=order.payment_intent.client_secret if include_client_secret else None,
        )
...
async def create_order(
    ...
    try:
        ...
        return _build_order_response(order, include_client_secret=True)
